...
<!-- inicio usuarios -->
<?php if(array_slice(explode('/', rtrim($_GET['url'], '/')), -1)[0] != "escritor")://tine un id -> viene de borrar o editar ?>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputUsername1" name="username" value="<?php echo $_SESSION['user_data']['userName']?>" disabled>
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Nombre</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="nombre"value="<?php echo $_SESSION['user_data']['name']?>" disabled>
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">apellido</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="apellido"value="<?php echo $_SESSION['user_data']['apellido']?>"disabled >
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputUsername1">Correo</label>
                                    <input type="text" class="form-control" id="exampleInputUsername1" name="correo" value="<?php echo $_SESSION['user_data']['correo']?>"disabled >
                                  </div>
