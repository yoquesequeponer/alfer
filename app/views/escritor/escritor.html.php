          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="data:img/jpg;base64,<?php echo base64_encode($data['users']->files->filedata); ?>" width="50px" alt="Profile image">
                                    ...
                                    <div class="form-group">
                                      ...
                                      imgInp.onchange = evt => {
                                        ...
                                        if (file) {
                                          ...
                                          <a type="button" class="btn btn-sm btn-info btn-icon-text" href="<?=ROOT_PATH?>users/edit/<?php echo $data['users']->id?>">
                                          Edit profile
