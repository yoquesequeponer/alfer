	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?= ROOT_PATH ?>">ALFER</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a href="<?=ROOT_PATH?>">Home</a></li>
					<?php if(isset($_SESSION['is_logged_in'])) : ?>
                    	<li><a href="<?php echo"/users/user" ?>">Perfil</a></li>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 widget">
						...
						<a href="mailto:#">
proyectotfgalvarofernandez@gmail.com</a><br>
								<br>
								Mi casa
						</div>
					</div>
					...
					<div class="col-md-6 widget">
						<h3 class="widget-title">Proyecto ALFER</h3>
						<div class="widget-body">
							<p>Proyecto de fin de grado de Desarrollo de Aplicaciones Web hecho por Álvaro Fernández</p>
						</div>
					</div>
